...
public:
    ...
    // Symbol: ?CreateFactory@__SettingsListViewItemActivationFactory@View@NetworkUX@@SAJPEAIPEAU__abi___classObjectEntry@@AEAVGuid@Platform@@PEAPEAU__abi_IUnknown@@@Z
    static long CreateFactory(unsigned int *, __abi___classObjectEntry *, ::Platform::Guid &, __abi_IUnknown * *);
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?GetTargetClassName@__SettingsListViewItemActivationFactory@View@NetworkUX@@SAPEB_WXZ
