...
public:
    ...
    // Symbol: ?CreateFactory@__MainPageActivationFactory@NetworkUX@@SAJPEAIPEAU__abi___classObjectEntry@@AEAVGuid@Platform@@PEAPEAU__abi_IUnknown@@@Z
    static long CreateFactory(unsigned int *, __abi___classObjectEntry *, ::Platform::Guid &, __abi_IUnknown * *);
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?GetTargetClassName@__MainPageActivationFactory@NetworkUX@@SAPEB_WXZ
