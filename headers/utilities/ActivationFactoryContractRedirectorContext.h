...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?get_WindowId@ActivationFactoryContractRedirectorContext@Details@PlatformExtensions@Internal@Windows@@UEAAJPEAUWindowId@WindowManagement@ApplicationModel@45ABI@@@Z
    virtual long get_WindowId(::ABI::Windows::Internal::ApplicationModel::WindowManagement::WindowId *);
    // Category: Method | Source: PDB Internal
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?put_WindowId@ActivationFactoryContractRedirectorContext@Details@PlatformExtensions@Internal@Windows@@UEAAJUWindowId@WindowManagement@ApplicationModel@45ABI@@@Z
    virtual long put_WindowId(::ABI::Windows::Internal::ApplicationModel::WindowManagement::WindowId);
};
} // namespace Windows::Internal::PlatformExtensions::Details
