...
static constexpr wchar_t module_name[14] = {0x004E, 0x0065, 0x0074, 0x0077, 0x006F, 0x0072, 0x006B, 0x0055, 0x0058, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2242867298U || rva >= image_size) return nullptr;
return base + rva;
}
