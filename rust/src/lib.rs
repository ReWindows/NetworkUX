//! Windissect-generated Rust FFI bindings for NetworkUX.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "121D55F8E7B3A446ADF92FD8EC98C999";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2242867298;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 14] = [78, 101, 116, 119, 111, 114, 107, 85, 88, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2242867298 { return 0; }
